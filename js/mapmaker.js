...
const FENCE_LOGIC_BY_ENVIRONMENT = {
    ...
    'Brawlywood': FENCE_LOGIC_TYPES.BINARY_PIECE,
    ...
    constructor(canvasId, headless = false) {
        ...
        this.environmentTileData = {
            ...
            Super_City: {
                ...
                'Bush': [1.1, 1.81, -6, -51, 1, 5],
                'Skull': [1, 1.08, 0, 5, 1, 5],
                '0001': [1 / 1.39, 1.39 / 1.39, 15, -28, 1, 5],
                '0010': [1, 1.85, 0, -55, 1, 5],
      ...
      Water_Park: {
            ...
            Medieval_Manor: {
                ...
                '0001': [1.350, 1.5, -16, -35, 1, 5],
                '0010': [1, 1.5, 0, -30, 1, 5],
                '0011': [1, 1.5, 0, -30, 1, 5],
                '0100': [1, 1.5, 0, -30, 1, 5],
                '0101': [1, 1.5, 0, -30, 1, 5],
                '1000': [1.350, 1.5, -16, -35, 1, 5],
                '1001': [1.350, 1.5, -16, -35, 1, 5],
                '1010': [1, 1.5, 0, -30, 1, 5],
                '1100': [1, 1.5, 0, -30, 1, 5],
        ...
        this.tileDefinitions = {
            ...
            45: { name: 'BFence', img: '${env}/Fence_5v5/BFence.png', showInEnvironment: ['Tropical_Island', 'Super_City_2', 'Bazaar', 'Medieval_Manor', 'Ice_Island', 'Subway_Surfers', 'Katana_Kingdom',], size: 1 },
